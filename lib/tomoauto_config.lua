...
-- These are the options for the beadtrack command used to fix the fiducial
-- model generated by RAPTOR.

-- RoundsOfTracking:
-- This option specifies how many rounds of tracking done by beadtrack.
-- Even rounds go one direction through the tilt series and odd rounds go the
-- other direction.
beadtrack_RoundsOfTracking = 20

-- TiltDefaultGrouping:
-- Default group size when automapping tilt angles
beadtrack_TiltDefaultGrouping = 5
...
beadtrack_SobelFilterCentering_use = true
