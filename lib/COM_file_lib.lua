...
local function write_beadtrack(input_filename, header)
   ...
   command_file:write(string.format(
         'MinViewsForTiltalign %d\n\n',
         beadtrack_MinViewsForTiltalign
      )
   )
   command_file:write(string.format(
         'MinTiltRangeToFindAxis %f\n\n',
   ...
   command_file:write(string.format(
         'PointsToFitMaxAndMin %s\n\n',
         beadtrack_PointsToFitMaxAndMin
      )
   )
   command_file:write(string.format(
         'DensityRescueFractionAndSD %s\n\n',
   ...
   command_file:write(string.format(
         'RescueRelaxationDensityAndDistance %s\n\n',
         beadtrack_RescueRelaxationDensityAndDistance
      )
   )
   command_file:write(string.format(
         'PostFitRescueResidual %f\n\n',
         beadtrack_PostFitRescueResidual
      )
   )
   command_file:write(string.format(
         'DensityRelaxationPostFit %f\n\n',
...
#                              write_autofidseed                               #
#------------------------------------------------------------------------------#
# Writes a command file for autofidseed                                        #
#===========================================================================--]]
local function write_autofidseed(input_filename)
   ...
   command_file:write(string.format(
         'TrackCommandFile %s_beadtrack.com\n\n',
         basename
      )
   )
   command_file:write(string.format(
   ...
   command_file:write(string.format(
         'PeakStorageFraction %f\n\n',
         autofidseed_PeakStorageFraction
      )
   )
   command_file:write(string.format(
         'TargetNumberOfBeads %d\n\n',
